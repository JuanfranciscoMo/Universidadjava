    ...
    private static boolean ejecutarOpciones(Scanner consola, int opcion,
        ...
        switch (opcion){
            ...
            case 2 ->{ // 2. Buscar cliente por id
                ...
                var encotrado = clienteDAO.buscarClientePorId(cliente);
                if (encotrado)
                    System.out.println("Cliente encotrado: " + cliente);
                else
                    System.out.println("Cliente NO encotrado: " + cliente);
            }
            ...
            case 5 -> { // 5. Eliminar Cliente
                ...
                System.out.print("Id Cliente: ");
                var idClinete = Integer.parseInt(consola.nextLine());
                var cliente = new Cliente(idClinete);
